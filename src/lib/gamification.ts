...
/** Builds a profile from the stroop amounts returned for leaderboard entries. */
export function calculateGamificationProfileFromStroops(
  totalAmountStroops: bigint,
): UserGamificationProfile {
  return calculateGamificationProfile(Number(totalAmountStroops) / STROOPS_PER_XLM);
}
