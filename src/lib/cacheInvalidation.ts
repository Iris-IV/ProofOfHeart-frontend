 ...
 */
function invalidateCampaignQueries(queryClient: QueryClient, campaignId: number): void {
 ...
 */
function invalidateContributorQueries(queryClient: QueryClient, walletAddress: string): void {
